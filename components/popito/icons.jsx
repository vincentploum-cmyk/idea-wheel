// Inline replacements for the template's imgToSVG behavior (init.js), which
// fetched /popito-assets/svg/*.svg at runtime and swapped <img class="fn__svg">
// for the real <svg> so style.css rules like `.fn__svg { fill: currentcolor }`
// could apply. Server-rendered inline SVG achieves the same with zero JS.
// Path data is copied verbatim from the original asset files.

export function CheckIcon({ className = 'fn__svg replaced-svg', width, height }) {
  return (
    <svg
      className={className}
      viewBox="0 0 450 412"
    ...
    >
      <g transform="translate(0,412) scale(0.1,-0.1)" stroke="none">
        <path d="M3873 4110 c-67 -27 -429 -294 -653 -480 -566 -472 -1156 -1079 -1633 -1681 -72 -92 -136 -168 -140 -168 -4 -1 -225 151 -490 336 -265 185 -491 342 -502 350 -11 7 -35 13 -54 13 -32 0 -51 -16 -213 -177 -220 -220 -216 -204 -101 -362 533 -735 1090 -1543 1253 -1818 40 -69 63 -97 88 -109 38 -18 82 -12 105 14 8 9 66 103 128 207 505 853 1145 1798 1673 2470 326 415 568 690 897 1017 242 241 259 260 259 294 0 46 -14 70 -50 89 -24 12 -76 15 -287 14 -142 0 -268 -4 -280 -9z" />
      </g>
    </svg>
  );
}

export function ArrowCurlyIcon({ className = 'fn__svg replaced-svg', width, height }) {
  return (
    <svg
      className={className}
      viewBox="0 0 323.03 66.2"
      width={width}
      height={height}
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
