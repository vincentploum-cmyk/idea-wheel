                ...
                <div className="footer_subscribe">
                  <div className="subscribe_title">
                    ...
                    <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', margin: '6px 0 0', lineHeight: 1.55, maxWidth: 320 }}>
                      Your ideas are private to your account. We save the ideas you generate, research, and blueprint so you get history and can pick up where you left off. We never sell them or make them public without your say-so.
                    </p>
                  </div>
