        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="zubuz-v3-thumb">
              <img src="/zubaz/images/v3/thumb-v3-2.png" alt="" />
              <div className="zubuz-v3-card">
                <img src="/zubaz/images/v3/card-v3-4.png" alt="" />
              </div>
            </div>
          </div>
              ...
              <div className="zubuz-extara-mt">
                <div className="zubuz-iconbox-wrap-left mw-100">
                  <div className="zubuz-iconbox-icon none-bg">
                    <img src="/zubaz/images/v3/icon11.png" alt="" />
                  </div>
                ...
                <div className="zubuz-iconbox-wrap-left mw-100">
                  <div className="zubuz-iconbox-icon none-bg">
                    <img src="/zubaz/images/v3/icon10.png" alt="" />
                  </div>
                  <div className="zubuz-iconbox-data data-small">
