            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="zubuz-video-wrap">
                  <img src="/zubaz/images/v3/video-bg.png" alt="" />
                  <button
                    className="video-init zubuz-review-video"
                    onClick={openPopup}
                  >
                    <img src="/zubaz/images/v3/play-btn.svg" alt="" />
              ...
              <div className="col-lg-6 d-flex align-items-center">
                <div className="zubuz-testimonial-content">
                  <ul>
                    <li>
                      <img src="/zubaz/images/v3/star.png" alt="" />
                    </li>
                    <li>
                      <img src="/zubaz/images/v3/star.png" alt="" />
                    </li>
                  ...
                  <div className="zubuz-testimonial-authors-wraps">
                    ...
                    <div className="zubuz-testimonial-author-logo">
                      <img src="/zubaz/images/v2/b_v2_5.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
