          ...
          <div className="row">
            <div className="col-xl-4 col-lg-12">
              <div className="zubuz-footer-textarea light">
                <Link href="/">
                  <img src="/zubaz/images/logo/logo-white.svg" alt="" />
                </Link>
                <p>
            ...
            <div className="col-xl-3 col-md-4">
              <div className="zubuz-footer-menu light info extar-margin">
                ...
                <ul>
                  <li>
                    <Link href="">
                      <img src="/zubaz/images/icon/call.svg" alt="" />
                      +088-234-6849
                    </Link>
                  </li>
                  <li>
                    <Link href="">
                      <img src="/zubaz/images/icon/email.svg" alt="" />
                      example@gmail.com
                    </Link>
                  </li>
                  <li>
                    <Link href="">
                      <img src="/zubaz/images/icon/map.svg" alt="" />
