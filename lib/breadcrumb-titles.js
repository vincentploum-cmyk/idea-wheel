...
export const BREADCRUMB_TITLES_BY_PATH = {
  // Pillar pages
  '/ai-startup-ideas': 'AI startup ideas',
  '/what-to-build-with-ai': 'What to build with AI',

  // /blog/[slug] — mirror BLOG_POSTS titles.
  '/blog/ai-app-ideas-people-will-pay-for': 'AI app ideas people pay for',
  '/blog/ai-business-ideas-you-can-start-solo': '25 AI business ideas to start solo',
  '/blog/how-to-use-google-trends-to-validate-a-startup-idea': 'Google Trends for idea validation',
  '/blog/how-to-find-micro-saas-ideas-with-real-demand': 'Find micro SaaS ideas with demand',
  '/blog/indie-hackers-startup-idea-validation-playbook': 'Indie hacker validation playbook',
  '/blog/how-to-use-reddit-to-validate-a-startup-idea': 'Reddit for idea validation',
  '/blog/startup-competitor-analysis-for-solo-founders': 'Competitor analysis for solo founders',
  '/blog/startup-idea-validation-checklist': 'Startup idea validation checklist',
