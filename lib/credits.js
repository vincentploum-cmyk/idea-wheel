...
export const CREDIT_PACKS = [
  { id: 'starter', label: 'Starter', credits: 5, price_cents: 499, price_display: '$4.99', tagline: 'Best first purchase' },
  { id: 'pro', label: 'Pro', credits: 10, price_cents: 900, price_display: '$9.00', tagline: 'Best for a focused build session' },
  { id: 'power', label: 'Power', credits: 25, price_cents: 1900, price_display: '$19.00', tagline: 'Best for testing multiple ideas' },
];
