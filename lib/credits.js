...
export const CREDIT_PACKS = [
  { id: 'starter', label: 'Starter', type: 'spin', credits: 5,  ideaCredits: 0, price_cents: 399,  price_display: '$3.99',  tagline: 'Spin credits for wheel & custom blueprints' },
  { id: 'pro',     label: 'Pro',     type: 'idea', credits: 0,  ideaCredits: 1, price_cents: 999,  price_display: '$9.99',  tagline: 'Unlock 1 curated idea — deep research + full blueprint' },
  { id: 'power',   label: 'Power',   type: 'idea', credits: 0,  ideaCredits: 2, price_cents: 1999, price_display: '$19.99', tagline: 'Unlock 2 curated ideas — deep research + full blueprint each' },
];
