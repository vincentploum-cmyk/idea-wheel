...
const B2B_WORKFLOW_INDUSTRY_MAP = {
  ...
  'vendor management': ['Construction', 'Logistics', 'Manufacturing', 'Property management', 'Restaurants', 'Retail', 'Auto repair shops'],
  'customer follow-ups': ['Healthcare', 'Legal services', 'Insurance', 'Dental practices', 'Accounting firms', 'Property management', 'Restaurants', 'Real estate', 'Veterinary clinics', 'Auto repair shops', 'Marketing agencies', 'Financial advisors', 'Physical therapy', 'Retail'],
  ...
  'inventory management': ['Manufacturing', 'Logistics', 'Restaurants', 'Retail', 'Auto repair shops', 'Veterinary clinics'],
  ...
  'quality control checks': ['Construction', 'Logistics', 'Manufacturing', 'Restaurants', 'Retail'],
  'subcontractor coordination': ['Construction', 'Manufacturing', 'Property management'],
  'delivery scheduling': ['Logistics', 'Restaurants', 'Retail'],
};
