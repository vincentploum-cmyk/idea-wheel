...
const B2B_WORKFLOW_INDUSTRY_MAP = {
  ...
  'contract management': ['Healthcare', 'Legal services', 'Construction', 'Logistics', 'Insurance', 'Manufacturing', 'Accounting firms', 'Property management', 'Real estate', 'Marketing agencies', 'Staffing agencies'],
  'compliance reporting': ['Healthcare', 'Construction', 'Logistics', 'Insurance', 'Dental practices', 'Manufacturing', 'Property management', 'Restaurants', 'Staffing agencies', 'Childcare', 'Physical therapy', 'Cleaning services'],
  ...
  'quote generation': ['Construction', 'Logistics', 'Insurance', 'Manufacturing', 'Property management', 'Real estate', 'Auto repair shops', 'Marketing agencies', 'Cleaning services'],
  'lead management': ['Healthcare', 'Legal services', 'Construction', 'Insurance', 'Dental practices', 'Accounting firms', 'Property management', 'Real estate', 'Veterinary clinics', 'Auto repair shops', 'Marketing agencies', 'Financial advisors', 'Physical therapy'],
  'document management': ['Healthcare', 'Legal services', 'Construction', 'Logistics', 'Insurance', 'Dental practices', 'Manufacturing', 'Accounting firms', 'Property management', 'Real estate', 'Marketing agencies', 'Financial advisors', 'Physical therapy'],
  'project tracking': ['Legal services', 'Construction', 'Logistics', 'Manufacturing', 'Property management', 'Marketing agencies', 'Staffing agencies'],
  'vendor management': ['Construction', 'Logistics', 'Manufacturing', 'Property management', 'Restaurants', 'Retail', 'Auto repair shops', 'Shopify store owners'],
  ...
  payroll: ['Healthcare', 'Construction', 'Logistics', 'Dental practices', 'Manufacturing', 'Accounting firms', 'Property management', 'Restaurants', 'Staffing agencies', 'Veterinary clinics', 'Auto repair shops', 'Cleaning services', 'Retail', 'Physical therapy', 'Childcare'],
  ...
  'billing & collections': ['Healthcare', 'Legal services', 'Logistics', 'Insurance', 'Dental practices', 'Accounting firms', 'Property management', 'Restaurants', 'Veterinary clinics', 'Physical therapy'],
  'field operations': ['Construction', 'Logistics', 'Manufacturing', 'Property management', 'Cleaning services'],
  'service request routing': ['Healthcare', 'Legal services', 'Property management', 'Auto repair shops', 'Cleaning services', 'Physical therapy'],
  'safety incident reporting': ['Construction', 'Logistics', 'Manufacturing', 'Restaurants', 'Cleaning services'],
  'equipment maintenance': ['Construction', 'Logistics', 'Manufacturing', 'Property management', 'Restaurants', 'Auto repair shops'],
  'crew dispatching': ['Construction', 'Logistics', 'Property management', 'Cleaning services'],
  'patient intake': ['Healthcare', 'Dental practices', 'Veterinary clinics', 'Physical therapy', 'Childcare'],
  'referral management': ['Healthcare', 'Insurance', 'Dental practices', 'Real estate', 'Veterinary clinics', 'Physical therapy', 'Financial advisors'],
  'renewal reminders': ['Legal services', 'Insurance', 'Property management', 'Financial advisors', 'Real estate'],
  'work order management': ['Construction', 'Logistics', 'Manufacturing', 'Property management', 'Auto repair shops', 'Cleaning services'],
  'quality control checks': ['Construction', 'Logistics', 'Manufacturing', 'Restaurants', 'Retail', 'Shopify store owners'],
  'subcontractor coordination': ['Construction', 'Manufacturing', 'Property management'],
  'delivery scheduling': ['Logistics', 'Restaurants', 'Retail', 'Shopify store owners'],
};
...
const CONSUMER_ACTION_WORKFLOW_MAP = {
  ...
  Manages: ['personal finances', 'mental health', 'fitness', 'meal planning', 'productivity', 'stress', 'daily schedule', 'nutrition', 'home routines', 'work-life balance', 'relationships', 'spending habits', 'morning routines', 'digital wellbeing', 'parenting', 'side hustle'],
  Builds: ['daily habits', 'career growth', 'productivity', 'skills', 'home routines', 'creative projects', 'morning routines', 'financial independence', 'reading habits', 'side hustle'],
  Optimizes: ['sleep', 'personal finances', 'fitness', 'meal planning', 'career growth', 'productivity', 'daily schedule', 'nutrition', 'home routines', 'work-life balance', 'spending habits', 'morning routines', 'workout recovery', 'focus & deep work', 'digital wellbeing', 'side hustle'],
  Plans: ['personal finances', 'fitness', 'career growth', 'daily schedule', 'nutrition', 'home routines', 'creative projects', 'work-life balance', 'social life', 'spending habits', 'morning routines', 'language learning', 'financial independence', 'parenting', 'reading habits', 'dating', 'side hustle'],
  Simplifies: ['personal finances', 'meal planning', 'productivity', 'daily schedule', 'nutrition', 'home routines', 'work-life balance', 'relationships', 'social life', 'spending habits', 'morning routines', 'digital wellbeing', 'parenting', 'dating', 'side hustle'],
  Coaches: ['sleep', 'fitness', 'meal planning', 'career growth', 'productivity', 'stress', 'skills', 'nutrition', 'work-life balance', 'learning', 'relationships', 'workout recovery', 'focus & deep work', 'journaling', 'language learning', 'dating', 'side hustle'],
  ...
  Reduces: ['stress', 'work-life balance', 'parenting'],
...
const CONSUMER_WORKFLOW_INDUSTRY_MAP = {
  ...
  nutrition: ['busy professionals', 'new parents', 'athletes', 'remote workers', 'healthcare workers', 'chronic illness patients'],
