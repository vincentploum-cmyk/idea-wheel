...
async function fetchTeams() {
  ...
  return Object.entries(TEAMS).map(([abbrev, t]) => ({ abbrev, name: t.name, full: t.full, place: null, conference: null, division: null, logo: `https://assets.nhle.com/logos/nhl/svg/${abbrev}_light.svg` }));
}
...
export function applyOverrides(players, overrides) {
  ...
  for (const [id, o] of Object.entries(overrides || {})) {
    ...
    out[id] = { ...base, ...Object.fromEntries(Object.entries(o).filter(([k, v]) => ['team', 'pos', 'name', 'excluded', 'note'].includes(k) && v !== undefined && v !== '')), overridden: true };
  }
  return out;
}
