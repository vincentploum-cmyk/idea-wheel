...
export const metadata = {
  ...
  description: 'IdeaReels helps vibe coders spin into buildable software ideas, sanity-check them fast, and unlock deeper research or a blueprint only when a project feels real.',
  keywords: ['idea generator for builders', 'startup idea wheel', 'vibe coding ideas', 'business idea validator', 'software idea generator', 'indie hacker tools'],
  authors: [{ name: 'IdeaReels' }],
  creator: 'IdeaReels',
  openGraph: {
    title: 'IdeaReels — spin up your next weekend build',
    description: 'For vibe coders, indie hackers, and solo builders. Spin into a real software idea, pressure-test it fast, and go deeper only when it earns it.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'IdeaReels — spin up your next weekend build',
    description: 'Spin into a buildable idea, sanity-check it fast, and unlock research or a blueprint when it feels real.',
    images: ['/og-image.png'],
  },
