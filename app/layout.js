...
export const metadata = {
  ...
  title: {
    default: 'IdeaReels — Market Research and MVP Blueprints for Builders',
    template: '%s | IdeaReels',
  },
  description: 'IdeaReels helps builders go from concept to market research to technical MVP blueprint, so they can decide what to build and how to execute.',
  ...
  openGraph: {
    ...
    description: 'For vibe coders, indie hackers, and solo builders. Go from concept to market research to technical MVP blueprint with a clear plan to execute.',
    type: 'website',
    url: 'https://ideareels.io',
    siteName: 'IdeaReels',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'IdeaReels — Market Research and MVP Blueprints for Builders' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'IdeaReels — Market Research and MVP Blueprints for Builders',
    description: 'Get the market research and technical MVP blueprint you need before committing to build.',
    images: ['/og-image.png'],
  },
