  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.disclaimer}>
        ...
        <p style={s.disclaimerText}>IdeaReels is an AI-powered research and ideation tool. All market analysis and recommendations are generated by AI for informational purposes only. Always conduct your own research before investing in any venture.</p>
      </div>
    </div>
  );
}
...
const s = {
  ...
  disclaimer: { position: 'relative', zIndex: 1, padding: '20px 24px 32px', borderTop: '1px solid #ece6f5', textAlign: 'center', maxWidth: 600, margin: '0 auto', width: '100%' },
