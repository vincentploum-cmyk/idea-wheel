...
export default function ProfileClient({ user, error }) {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.center}>
        <div style={s.card}>
          <a href="/" style={s.back}>← Idea Generator</a>
          ...
          {user ? (
            <>
              ...
              <div style={s.section}>
                ...
                <span style={s.credval}>—</span>
                <span style={s.crednote}>Credits are currently stored locally. Account-linked credits coming soon.</span>
              </div>
...
const s = {
  ...
  card: {
    ...
    flexDirection: 'column',
    alignItems: 'center',
    boxShadow: '0 10px 40px -12px rgba(80,30,120,0.2)',
  },
  back: { alignSelf: 'flex-start', fontSize: 13, color: '#7a7191', textDecoration: 'none', marginBottom: 24 },
  avatar: {
    width: 56, height: 56, borderRadius: '50%',
    background: 'linear-gradient(120deg,#7c3aed,#c026d3,#ff4d8d)',
  ...
  credval: { fontSize: 22, fontWeight: 900, fontFamily: '"Sora", system-ui', color: '#18112b' },
  crednote: { fontSize: 11.5, color: '#7a7191', lineHeight: 1.5 },
  ...
  submitBtn: { width: '100%', padding: '12px', background: 'linear-gradient(120deg,#7c3aed,#c026d3,#ff4d8d)', color: '#fff', border: 'none', borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: '"Plus Jakarta Sans", system-ui' },
